...
agent-harness release activation-plan [--control-root <path>] [--data-root <path>] [--project <id>] [--project-descriptor <json>]... [--extension-replacements <json>]
...
if (command === 'release' && subject === 'activation-plan') {
  ...
  const plan = await createReleaseActivationPlan({ controlRoot, dataRoot, releaseIdentity, projectIds: takeAll('--project'), projectDescriptors, extensionReplacements });
