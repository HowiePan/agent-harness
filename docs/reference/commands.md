...
制品和本机插件命令按渠道命名：`npm run pack:core`、`npm run pack:codex`、`npm run deploy:codex`、`npm run release:codex:check`、`npm run release:codex:local`。具体产物见[渠道打包](./packaging.md)。
