...
import { digestJson, newId, sha256 } from '../../../src/common/canonical.mjs';
import { assert } from '../../../src/common/errors.mjs';
import { assertSchemaDefinition } from '../../../src/common/json-schema.mjs';
...
import { createManagedOutputSession } from '../../../src/platform/plugins/execution/managed-output.mjs';
import { compileAgentPrompt } from '../../../src/platform/plugins/codec/agent-prompt-codec.mjs';
import { assertAgentRuntimeLaunchCapability } from '../../../src/platform/execution/authorization.mjs';
